...
public class LogcatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iv_minimum = mRoot.findViewById(R.id.iv_minimum);

        mIvClean.setOnClickListener(this);
        mIvShare.setOnClickListener(this);
        mIvZoomOut.setOnClickListener(this);
        iv_minimum.setOnClickListener(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
            ...
            if(requestCode == REQUEST_SCREEN_OVERLAY_MIN){
                FloatingLogcatService.launch(getApplicationContext(),true);
            }else if(requestCode == REQUEST_SCREEN_OVERLAY){
    ...
    public void onClick(View v) {
        ...
        //最小化
        else if (v.getId() == R.id.iv_minimum) {
            minimum(true);
        }


    }
    private  void  minimum(boolean minimum){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(context)) {
            ...
            FloatingLogcatService.launch(context,minimum);
            finish();
        }
    }
