...
public class FloatingLogcatService extends Service implements View.OnClickListener {
    ...
    public static void launch(Context context,boolean minimum) {
        Intent intent = new Intent(context, FloatingLogcatService.class);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        boolean  minimum = intent.getBooleanExtra("minimum",false);
        ...
        iv_resize = mRoot.findViewById(R.id.iv_resize);

        mIvClean.setOnClickListener(this);
        mIvShare.setOnClickListener(this);
        mIvZoomOut.setOnClickListener(this);
        iv_resize.setOnClickListener(this);
    ...
    private void initViews(boolean minimum) {
        ...
        if (wm == null) {
            ...
            if(minimum){
                height =  dip2px(getApplicationContext(),48);;
            }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.iv_clean) {
            ...
            if(mIsResize){
                ...
                wm.updateViewLayout(mRoot, layoutParams);
            }else {
                wm.removeView(mRoot);
                stopReadLogcat();
        ...
        }else if (v.getId() == R.id.iv_resize) {
            mIsResize = true;
            ViewGroup.LayoutParams layoutParams =  mRoot.getLayoutParams();
